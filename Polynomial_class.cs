...
{
    internal class Polynomial_class
    {
        ...
        internal static string CalculateOrder(VandermondeMatrixClass matrix)
        {
        ...
        static public Dictionary<int, double> Calculate(double[] values)
            ...
            static public double CalculateRoot(double[] coefficients, double initialGuess)
            {
                for (int i = 0; i < 100; i++)
                {
                    ...
                    initialGuess -= (Polynomial_class.Calculate(coefficients, initialGuess) / Polynomial_class.CalculateDerivative(coefficients, initialGuess));
